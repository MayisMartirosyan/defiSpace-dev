...
search_input_desktop.addEventListener("focus", () => {
    ...
    // timeline_calendar_select_div_desktop.style.width = "0px";
...
search_max_vector_desktop_div.addEventListener("click", () => {
    ...
    timeline_calendar_desktop.style.minWidth = "180px";
    ...
    // timeline_calendar_select_div_desktop.style.width = "auto";
    timeline_calendar_div_desktop.style.height = "40px";
