document.addEventListener("DOMContentLoaded",()=> {
    ...
    let newsBtn = document.querySelector('.nav_item_text:contains("News")');

    console.log(newsBtn,'ssss');

    if(currentUrl.includes('/post')){
       
        newsBtn[i].classList.add("nav_active");
        newsBtn[i].children[0].children[0].style.color = "white";
    }   
